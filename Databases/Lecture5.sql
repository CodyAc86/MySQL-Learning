...
In most of the cases, the join key is the primary key of 
one table and a foreign key in another table. The join is possible
as long as data in columns are matching.
...
right side of the join statement even if no matching record in not found on the left.
